...
VALUES('Espresso',2.50,'Brazil'),('Macchiato',3.00, 'Brazil'),('Capuccino',3.50,'Costa Rica'),('Latte',3.50,'Indonesia'),('Americano',3.00,'Brazil'),
('Flat White',3.50,'Indonesia'),('Filter',3,'India');
...
UPDATE products
SET origin='Sri Lanka',price=4.00 
WHERE id=7;
...
-- Creating a dummy database and table for practicing deleting of data
...
CHANGE COLUMN gender lastname VARCHAR(20);

ALTER TABLE customers
CHANGE COLUMN last_name gender_hehe VARCHAR(20);

ALTER TABLE customers
CHANGE COLUMN lastname last_name VARCHAR(20);

ALTER TABLE customers
CHANGE COLUMN gender_hehe gender VARCHAR(20);
